...
app.get("/jokes/:id", (req,res)=>{
  ...
  const foundJoke = jokes.find((joke) => joke.id === id); //finds a joke whose id matches with id it got from request
  res.json(foundJoke); //returns json format of the found joke with joke.id = id
});
